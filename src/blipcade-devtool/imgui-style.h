...
#include "IconsForkAwesome.h" // from https://github.com/juliettef/IconFontCppHeaders

namespace ImGui
{

    static ImFont* font1 = NULL;
    ...
    inline void SetupImGuiStyle( bool bStyleDark_, float alpha_  )
    {
        ...
        font1 = io.Fonts->AddFontFromFileTTF("resources/Rubik-Light.ttf", 15.0f);
        // font1 = io.Fonts->AddFontFromFileTTF("resources/FiraCode-Light.ttf", 15.0f);
...
//        style.Colors[ImGuiCol_ModalWindowDarkening]  = ImVec4(0.20f, 0.20f, 0.20f, 0.35f);
    ...
    {
        return CheckBoxFont( name_, pB_, ICON_FK_CHECK_SQUARE_O, ICON_FK_SQUARE_O );
    }
    ...
    inline bool MenuItemCheckbox( const char* name_, bool* pB_ )
    {
        ...
        if( *pB_ )
        {
            ImGui::Text(ICON_FK_CHECK_SQUARE_O);
        }
        else
        {
            ImGui::Text(ICON_FK_SQUARE_O);
        }
        if( retval )
        {
            *pB_ = ! *pB_;
